...
export default function Home() {
  ...
  // Card colors and values - updated to green theme
  const cardInfo = [
    { color: '#00873c', value: 'A', suit: '♥' },
    { color: '#005a20', value: 'K', suit: '♣' },
    { color: '#00a65a', value: 'Q', suit: '♠' },
    { color: '#00732e', value: 'J', suit: '♦' },
    { color: '#007f3a', value: '10', suit: '♥' },
    { color: '#004d25', value: '9', suit: '♠' },
    { color: '#006633', value: '8', suit: '♦' }
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Animated sparkles - changed to green */}
      {sparkles.map(sparkle => (
        <View
          key={sparkle.id}
          style={[
      ...
      >
        <View style={[styles.chipInner, { backgroundColor: '#00a65a' }]} />
      </Animated.View>
      ...
      >
        <View style={[styles.chipInner, { backgroundColor: '#004d25' }]} />
      </Animated.View>
...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: '#0f1c14', // Darker green background
    width: '100%',
    height: '100%',
    position: 'relative',
    overflow: 'hidden',
  ...
  sparkle: {
    position: 'absolute',
    backgroundColor: '#0c6', // Green sparkles
    borderRadius: 50,
    opacity: 0.8,
    animation: 'sparkle-animation 2s infinite',
  },
  ...
  diceDot: {
    ...
    width: 6,
    height: 6,
    backgroundColor: '#003f1f', // Darker green dots
    borderRadius: 3,
    top: 8,
    left: 8,
  },
  ...
  rummyButton: {
    backgroundColor: '#00873c', // Green button
  },
  casinoButton: {
    backgroundColor: '#00a65a', // Lighter green button
  },
  buttonText: {
    color: '#ffffff',
    fontSize: 18,
